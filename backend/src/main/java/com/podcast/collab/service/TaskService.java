...
public class TaskService {
    ...
    public TaskDTO createTask(CreateTaskRequest request) {
        ...
        AuditLogContext.setEntityId(task.getId());
        return TaskDTO.fromEntity(task);
    }
    ...
    @Transactional
    @AuditLog(action = "UPDATE_TASK_STATUS", entityType = "TASK")
    ...
    @Transactional
    @AuditLog(action = "ASSIGN_TASK", entityType = "TASK")
    public TaskDTO assignTask(Long id, AssignTaskRequest request) {
        ...
        task = taskRepository.save(task);
        AuditLogContext.setEntityId(id);
        AuditLogContext.setDetails(Map.of("assigneeId", assigneeId));
        return TaskDTO.fromEntity(task);
    }
